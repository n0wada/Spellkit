...
internal static class BCL
{
    ...
    public static readonly Type SpkObject = typeof(SpkObject);
...
public static partial class Spk
{
    ...
    internal static FastList<SpkTypeInfo> GetAll()
    {
        var xs = new FastList<SpkTypeInfo>();
        GetAllGenerated(xs);
        return xs;
    }
    static partial void GetAllGenerated(FastList<SpkTypeInfo> types);
    ...
    public static SpkTypeInfo GetMixinByCode(int code)
    {
        SpkTypeInfo mixin = null!;
...
public class SpkTypes
{
    public readonly static SpkNil Nil = SpkNil.Instance;
    public readonly static SpkBool True = SpkBool.True;
    public readonly static SpkBool False = SpkBool.False;
}
