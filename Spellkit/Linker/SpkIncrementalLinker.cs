...
internal sealed class SpkIncrementalLinker : SpkLinker
{
    private SpkCompiler? compiler;
    private SpkCompiler? oldCompiler;
    ...
    protected override Unit? CompileNodes(SpkCodeModel codeModel, bool root)
    {
        if (!root)
        {
