...
internal static class HostingScenarios
{
    ...
    internal static void PublicApiNames()
    {
        ...
        AssertNoMethod<SpellkitInstance>("Execute", "synchronous instance execution");
        AssertHasMethod<SpellkitInstance>("ExecuteAsync", "asynchronous instance execution");
        AssertNoMethod<SpellkitInstance>("ExecuteFile", "synchronous explicit script file execution");
        AssertHasMethod<SpellkitInstance>("ExecuteFileAsync", "asynchronous file execution");
        AssertNoMethod<SpellkitInstance>("Start", "synchronous suspended run creation");
        AssertNoMethod<SpellkitInstance>("OpenSelect", "synchronous basic interactive select creation");
        AssertHasMethod<SpellkitInstance>("OpenSelectAsync", "asynchronous basic interactive select creation");
        AssertNoMethod<SpellkitInstance>("OpenSelectSession", "synchronous advanced interactive select creation");
        ...
        AssertNoMethod<SpellkitInstance>("DispatchSignals", "synchronous pending signal dispatch");
        AssertHasMethod<SpellkitInstance>("DispatchSignalsAsync", "asynchronous signal dispatch");
        AssertNoMethod<SpellkitSelectSession>("Select", "synchronous select choice");
        AssertNoMethod<SpellkitSelectSession>("Send", "synchronous select host event delivery");
        AssertNoMethod<SpellkitSelectSession>("Refresh", "synchronous select refresh");
        AssertNoMethod<SpellkitSelectSession>("Invalidate", "synchronous select invalidation");
        ...
        AssertHasMethod<SpellkitSelectSession>("RefreshAsync", "asynchronous select refresh");
        AssertHasMethod<SpellkitSelectSession>("InvalidateAsync", "asynchronous select invalidation");
        AssertNoMethod<SpellkitSelect>("Select", "synchronous basic select choice");
        AssertNoMethod<SpellkitSelect>("Send", "synchronous basic select host event delivery");
        AssertHasMethod<SpellkitSelect>("SelectAsync", "asynchronous basic select choice");
        AssertHasMethod<SpellkitSelect>("SendAsync", "asynchronous basic select host event delivery");
        AssertNoMethod<SpellkitRunSession>("Select", "synchronous suspended run choice");
        AssertNoMethod<SpellkitRunSession>("Send", "synchronous suspended run host event delivery");
