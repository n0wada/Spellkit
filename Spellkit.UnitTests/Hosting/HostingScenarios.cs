...
internal static class HostingScenarios
{
    ...
    internal static void PublicApiNames()
    {
        ...
        AssertNoMethod<SpellkitInstance>("OpenSelectSessionAsync", "internal select session creation");
        ...
        AssertHasMethod<SpellkitSelect>("RefreshAsync", "asynchronous select refresh");
        ...
        AssertNoProperty<SpellkitSelectRevisionMismatchException>("Snapshot", "internal stale-select snapshot");
        ...
        AssertHasMethod<SpellkitRunSession>("RefreshAsync", "asynchronous suspended run select refresh");
        AssertHasMethod<SpellkitRunSession>("InvalidateAsync", "asynchronous suspended run select invalidation");
