...
public sealed partial class SpkConsoleTypeInfo : SpkForeignTypeInfo
{
    ...
    private static void WriteToConsole(ExecutionContext ctx, SpkObject value, string? color, string? backColor, bool newLine)
    {
    ...
    [SpkStaticMethod]
    internal static void WriteLine(ExecutionContext ctx, [Default]SpkObject value, string? color = null, string? backColor = null) =>
        WriteToConsole(ctx, value, color, backColor, newLine: true);

    [SpkStaticMethod]
    internal static void Write(ExecutionContext ctx, SpkObject value, string? color = null, string? backColor = null) =>
    ...
    [SpkStaticMethod]
    internal static SpkObject GetCursorPosition()
    {
        var (left, top) = Console.GetCursorPosition();
        return SpkTuple.Create(new("left", left), new("top", top));
    }
    ...
    [SpkStaticMethod]
    internal static void SetOutput(ExecutionContext ctx, SpkObject? write = null, SpkObject? writeLine = null)
    {
    ...
    [SpkStaticMethod]
    internal static void SetInput(ExecutionContext ctx, SpkObject? read = null, SpkObject? readLine = null)
    {
    ...
    [SpkStaticMethod]
    internal static SpkObject ReadKey(ExecutionContext ctx, bool intercept = false)
    {
        try
        {
